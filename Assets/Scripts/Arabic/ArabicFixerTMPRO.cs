...
public class ArabicFixerTMPRO : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUIWithChangeEvent tmpTextComponent;
    ...
    public void Awake()
    {
        ...
        isInitilized = false;
        tmpTextComponent = GetComponent<TextMeshProUGUIWithChangeEvent>();
    }
    ...
    public void Start()
    {
        ...
        tmpTextComponent.TextValueChanged += TmpTextComponent_TextValueChanged;
    }

    private void TmpTextComponent_TextValueChanged(string obj)
    {
        fixedText = tmpTextComponent.text;
    }
    ...
    public void Update()
    {
        ...
        //Debug.Log("tmpTextComponent.text = " + tmpTextComponent.text);
        //Debug.Log("tmpTextComponent.text == fixedText" + tmpTextComponent.text.ToString() == fixedText.ToString());
